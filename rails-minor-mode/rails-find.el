...
(rails-find:gen "layout"      "app/views/layouts/application.html.slim")
...
(rails-find:gen "Gemfile"     "Gemfile")
(rails-find:gen "initializers"    "config/initializers")
(rails-find:gen "routes"    "config/routes.rb")
