...
(define-abbrev-table 'exps-display-mode-abbrev-table '())
...
(define-abbrev-table 'jinja-mode-abbrev-table '())
...
(define-abbrev-table 'less-mode-abbrev-table '())
...
(define-abbrev-table 'semantic-regtest-mode-abbrev-table '())
...
(define-abbrev-table 'wisent-grammar-mode-abbrev-table '())
